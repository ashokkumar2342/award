...
Route::group(['middleware' => 'admin'], function() {
	...
	Route::get('payment-status2', 'BookingController@BookingStatus2')->name('admin.booking.status2'); 
	Route::get('approve/{id}', 'BookingController@approve')->name('admin.booking.approve'); 	
	Route::get('reject/{id}', 'BookingController@reject')->name('admin.booking.reject'); 	
	...
	Route::get('booking2', 'BookingController@showBookingForm2')->name('admin.booking2'); 	//OK-------------
	...
	Route::group(['prefix' => 'online-pay'], function() {
   		...
   		Route::post('payment-store2', 'BookingController@storeBooking2')->name('admin.booking.store2'); 	//OK------------

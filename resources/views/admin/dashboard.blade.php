  ...
  <div class="container-fluid"> 
    <div class="row">
          ...
          <div class="col-md-12 col-sm-6 col-12">
            <div class="info-box">
              <div class="info-box-content">
                <a href="{{ route('admin.booking') }}" class="btn btn-lg btn-info" style="background:#71b371">Individual Award Form</a>
              </div>
              <div class="info-box-content">
                <a href="{{ route('admin.booking2') }}" class="btn btn-lg btn-info" style="background:#71b371">Institute Award Form</a>
              </div>

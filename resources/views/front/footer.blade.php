                ...
                <div class="col-md-3">
                    <div class="foo_col_outer_wrap default_width">
                        ...
                        <div class="gt_foo_about widget">
                            <h5>About IAMRF</h5>
                            <p>IAMRF, A Unit of Sir Salasar Balaji Enterprises Private Limited is a Modern Indian Village surrounded by lush green agricultural fields in an Eco-friendly area.</p> 
                        </div>
                    </div>
                </div> 
                <div class="col-md-9">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="widget">
                                    ...
                                    <ul class="gt_team1_contact_info">
                                        ...
                                        <li><i class="fa fa-envelope"></i> <a href="#">info@IAMRF.in</a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="copyright_bg default_width">
        <div class="container">
            <div class="copyright_wrap default_width">
                <p>©copyrights.<a href="#">IAMRF.in</a>. All Right Reserved.</p>
            </div>
        </div>
    </div>  
    <!--Copyright Wrap End-->      

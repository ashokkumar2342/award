...
class SmsEventListener
{
  ...
  {   
       ...
       // \Log::info($url); 
        ...
        $url = "http://smsdealnow.com/api/pushsms?user=IAMRF&authkey=927mh3X5DzDjQ&sender=SSBEPL&mobile=$event->mobile&text=$event->message&entityid=1701163748607955584&templateid=$event->tempid&rpt=1";
